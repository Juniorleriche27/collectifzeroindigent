...
-- Compatibilite legacy: certaines bases ont encore field_changed/old_value/new_value
-- en NOT NULL (ancien schema). Le trigger moderne n'alimente plus ces colonnes.
do $$
begin
  if exists (
