...
const supabase_data_service_1 = require("./supabase-data.service");
let InfraModule = class InfraModule {
};
exports.InfraModule = InfraModule;
exports.InfraModule = InfraModule = __decorate([
    (0, common_1.Module)({
        exports: [supabase_data_service_1.SupabaseDataService],
        providers: [supabase_data_service_1.SupabaseDataService],
    })
], InfraModule);
